# Electric Forest 2026 — Bungalow Packing Checklist

*Good Life · Pre-set 4-person tent: 4 twin cots + 4 souvenir sleeping bags (yours to keep) + 4 pillows; 1 side table; 1 battery light; tent lock; single in-tent outlet. NO cooling unit, NO towels. · arrival Wednesday June 24 included.*
...
- Sleeping bags and/or sleeping pads/cots provided.
- Camp furniture provided (side tables, chairs, and/or bistro table).
- Only a single battery light is provided — bring an extra lantern.
...
- Bring a fan — no cooling unit (tents run hot).
- Bring your own towels (not provided).
- Sheet/liner for cots if desired; extra lantern (only one battery light included).
- Same outlet caveat as Electric Avenue — small devices only.
- Bring cooler + food + stove; toiletries; power bank.
...
- [ ] Sheet or sleeping-bag liner — _Provided sleeping bags/cots come without sheets — bring a liner._
...
- [ ] Extra lantern — _Only one battery light is included._
- [ ] Spare batteries
